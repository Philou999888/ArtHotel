                ...
                <div class="container">
                    ...
                    <div class="row justify-content-between flex-sm-row-reverse mil-p-100-40">
                            ...
                            <div class="row justify-content-between">
                                <div class="col-md-6 col-lg-4 mil-mb-40">
                                    <div class="footmenu">
                                        ...
                                        <a href="<?=$GLOBAL["linkroot"];?>">> Startseite</a><br>
                                        <a href="<?=$GLOBAL["linkroot"];?>/ueber-uns">> Unsere Philosophie</a><br>
                                        <a href="<?=$GLOBAL["linkroot"];?>/zimmer">> Zimmer & Preise</a>
                                    </div>
                                </div>
                                <div class="col-md-6 col-lg-4 mil-mb-40">
                                    <div class="footmenu">
                                        <h5 class="mil-mb-20">Kontakt</h5>
                                        <span style="padding-bottom:5px;">Mo-So | 8:00 - 23:00 Uhr</span><br>
                                ...
                                <div class="col-md-6 col-lg-4 mil-mb-40">
                                    <h5 class="mil-mb-20"><a href="<?=$GLOBAL["linkroot"];?>/impressum" style="color:black;">Impressum</a></h5>
                                    <p>
                                    Art Hotel Vienna<br>
                        ...
                        <div class="col-md-4 col-lg-4 mil-mb-60">
                            ...
                            <a href="<?=$GLOBAL["linkroot"];?>/impressum" style="color:black;text-decoration: none;">Datenschutzerklärung</a>
							<br><br>
        ...
        <div class="mil-book-popup-frame">
            <div class="mil-book-popup">
                <div class="mil-popup-head mil-mb-40">
                    <h3 class="mil-h3-lg">Jetzt buchen</h3>
