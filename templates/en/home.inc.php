...
<body>
    ...
    <div class="mil-wrapper">
        ...
        <div class="mil-content-pad mil-p-100-100">
            <div class="container">
                <div class="mil-text-center">
                    <div class="mil-suptitle mil-mb-20 mil-fade-up">The Art Hotel</div>
                    <h2 class="mil-mb-20 mil-fade-up">We look forward to welcoming you to the Art Hotel Vienna</h2>
                </div>

                <div class="row mil-mb-60">
                    <div class="col-lg-12 mil-text-center">
                        <p class="mil-fade-up">Experience Viennese art and culture in our 3-star hotel designed with artistic details. Our newly refurbished rooms and flats are characterised by their exclusive interior design. Book today and enjoy an unforgettable stay in Vienna.
                        </p>
                    </div>
                </div>
        ...
        <div class="mil-features mil-p-100-60">
            ...
            <div class="container">
                <div class="mil-text-center">
                    <div class="mil-suptitle mil-mb-20 mil-fade-up">Your benefits</div>
                    <h2 class="mil-mb-100 mil-fade-up">Why you will love the Art Hotel</h2>
                </div>
                <div class="row">
                    <div class="col-md-6 col-xl-4">
                        <div class="mil-iconbox mil-mb-40-adapt mil-fade-up">
                            ...
                            <h3 class="mil-mb-20">Perfect accessibility</h3>
                            <p>Our hotel is just 20 minutes from Vienna Central Station. Supermarkets and restaurants are just a 5-minute walk away. You can reach almost all of Vienna's sights in 30 minutes. Travelling by car? Simply book our underground car park.</p>
                        </div>
                    </div>
                    <div class="col-md-6 col-xl-4">
                        <div class="mil-iconbox mil-mb-40-adapt mil-fade-up">
                            ...
                            <h3 class="mil-mb-20">Upscale comfort</h3>
                            <p>Our hotel rooms are equipped with towels, toiletries, a hairdryer and a kitchenette. In our flats you will also find a fully equipped kitchen. We offer you an extensive breakfast buffet so that you can start your day on holiday feeling refreshed.</p>
                        </div>
                    </div>
                    <div class="col-md-6 col-xl-4">
                        <div class="mil-iconbox mil-mb-40-adapt mil-fade-up">
                            ...
                            <h3 class="mil-mb-20">Best service</h3>
                            <p>Our reception will give you a warm welcome on your arrival, assist you in all matters and answer your questions. Our service team will ensure that your stay is a pleasant and smooth one.</p>
                        </div>
                    </div>
        ...
        <div class="mil-content-pad mil-p-100-100 mil-mb-100" style="background-image: url(<?=$GLOBAL["root"];?>assets/img/shapes/5.png); background-size: 100%">
            <div class="container">
                ...
                <div class="mil-text-center">
                    <div class="mil-suptitle mil-mb-20 mil-fade-up">Testimonials</div>
                    <h2 class="mil-mb-40 mil-fade-up">What our guests have to say</h2>
                </div>
                            ...
                            <div class="swiper-wrapper">
                                <div class="swiper-slide">
                                    <div class="mil-review-frame mil-text-center" data-swiper-parallax="-250" data-swiper-parallax-opacity="0">
                                        <p class="mil-fade-up mil-mb-20">The hotel impressed us with its exceptional service and warm hospitality, which you could feel in every detail. The central location made it easy for us to explore the beautiful city of Vienna. A perfect stay for our city trip.</p>
                                ...
                                <div class="swiper-slide">
                                    <div class="mil-review-frame mil-text-center" data-swiper-parallax="-250" data-swiper-parallax-opacity="0">
                                        <p class="mil-fade-up mil-mb-20">Our room at the hotel was cosy and clean, with a beautiful view of the lively streets of Vienna. The breakfast buffet offered a rich selection of fresh products, which surprised us very positively.</p>
                                        <div class="mil-fade-up">
                                ...
                                <div class="swiper-slide">
                                    <div class="mil-review-frame mil-text-center" data-swiper-parallax="-250" data-swiper-parallax-opacity="0">
                                        <p class="mil-fade-up mil-mb-20">I was in Vienna on business and found exactly what I needed in this hotel: a quiet atmosphere, fast Wi-Fi and efficient room service. The proximity to the underground was an added bonus. The artful and thoughtful decor can really only be emphasised positively!</p>
                                        <div class="mil-fade-up">
                                ...
                                <div class="swiper-slide">
                                    <div class="mil-review-frame mil-text-center" data-swiper-parallax="-250" data-swiper-parallax-opacity="0">
                                        <p class="mil-fade-up mil-mb-20">The hotel offered us a wonderful experience with its traditional Viennese charm and modern amenities. The staff were always friendly and accommodating which made our stay particularly enjoyable. Great value for money and ideal for families.</p>
                                        <div class="mil-fade-up">
                ...
                <div class="row justify-content-between align-items-center flex-sm-row-reverse">
                    <div class="col-xl-5 mil-mb-100">
                        ...
                        <div class="mil-text-frame">
                            ...
                            <p class="mil-mb-20 mil-fade-up">The culture of the city of Vienna, its history and its urban flair continue in our Art Hotel Vienna. The Art Hotel is characterised by its artistic design. This begins with a colourful painting that covers the entire façade of the hotel and continues in the form of works of art and murals in the interior rooms. The rooms have also recently been redesigned and offer a feel-good atmosphere with modern and high-quality interior design.
</p>

                            <p class="mil-mb-40 mil-fade-up">The artistic flair is the finishing touch. Of course, you can also expect all the amenities of a well-run hotel. These include quiet and comfortable rooms, an extensive breakfast and care products in all rooms.
</p>
