...
<head>
    ...
    <!-- page name -->
    <title>Location | Art Hotel Vienna</title>
                    ...
                    <div class="col-xl-6">
                        ...
                        <div class="mil-banner-content-frame">
                            <div class="mil-banner-content mil-text-center">
                                <h1 class="mil-mb-40">Find us here</h1>
        ...
        <div class="mil-p-0-100">
            <div class="container">
				...
				if($_SESSION["cookieconsent"] != "ok") {
					...
					<i>We use Google Maps to display the site map.<br>Third-party cookies are set by Google and Matomo. </i>
					<br><br>
					<a href="?consent=true" style="color:black;text-decoration:none;margin:20px;">
						<span style="background:transparent;border:black solid 1px;padding:10px;color:black;text-decoration:none;">&raquo; Agree, load the map</span>
					</a>
					</div>
					<?
				}else{
